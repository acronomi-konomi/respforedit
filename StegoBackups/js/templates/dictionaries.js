// ==========================================
// 📚 DICTIONARIES MODULE (dictionaries.js)
// ==========================================
...
export const INGREDIENT_CATEGORIES = {
    ...
    produce: [
        ...
        { name: 'чеснок', measure: 'clove', canChop: true }, { name: 'морковь', measure: 'piece', canChop: true },
        { name: 'морковь по-корейски', measure: 'weight', canChop: true }, { name: 'свёкла', measure: 'piece', canChop: true },
        { name: 'капуста белокочанная', measure: 'weight', canChop: true }, { name: 'капуста цветная', measure: 'head', canChop: true },
        { name: 'брокколи', measure: 'head', canChop: true }, { name: 'кабачок', measure: 'piece', canChop: true },
        ...
        { name: 'сельдерей стебли', measure: 'piece', canChop: true }, { name: 'шпинат свежий', measure: 'bunch', canChop: true },
        { name: 'щавель', measure: 'bunch', canChop: true }, { name: 'салат айсберг', measure: 'head', canChop: true },
        { name: 'руккола', measure: 'bunch', canChop: true }, { name: 'базилик свежий', measure: 'bunch', canChop: true },
        { name: 'укроп', measure: 'bunch', canChop: true }, { name: 'петрушка', measure: 'bunch', canChop: true },
        { name: 'кинза', measure: 'bunch', canChop: true }, { name: 'мята свежая', measure: 'bunch', canChop: true },
        ...
        { name: 'тыква', measure: 'weight', canChop: true }, { name: 'кукуруза консервированная', measure: 'spoonT', canMix: true },
        { name: 'горошек зелёный', measure: 'spoonT', canMix: true }, { name: 'фасоль стручковая', measure: 'weight', canChop: true },
        { name: 'фасоль красная', measure: 'weight', canMix: true }, { name: 'чечевица красная', measure: 'weight', canMix: true },
        { name: 'нут', measure: 'weight', canMix: true }, { name: 'соевые бобы', measure: 'weight', canMix: true },
    ],
    fruits: [
        ...
        { name: 'нектарин', measure: 'piece', canChop: true }, { name: 'вишня', measure: 'piece', canChop: true },
        { name: 'черешня', measure: 'piece', canChop: true }, { name: 'клубника', measure: 'piece', canChop: true },
        { name: 'малина', measure: 'piece', canMix: true }, { name: 'смородина чёрная', measure: 'piece', canMix: true },
        { name: 'смородина красная', measure: 'piece', canMix: true }, { name: 'крыжовник', measure: 'piece', canChop: true },
        { name: 'черника', measure: 'piece', canMix: true }, { name: 'голубика', measure: 'piece', canMix: true },
        { name: 'ежевика', measure: 'piece', canMix: true }, { name: 'клюква', measure: 'piece', canMix: true },
        { name: 'брусника', measure: 'piece', canMix: true }, { name: 'облепиха', measure: 'piece', canMix: true },
        ...
        { name: 'изюм', measure: 'spoonT', canMix: true }, { name: 'курага', measure: 'piece', canChop: true },
        { name: 'чернослив', measure: 'piece', canChop: true }, { name: 'инжир сушёный', measure: 'piece', canChop: true },
        { name: 'миндаль', measure: 'piece', canChop: true }, { name: 'фундук', measure: 'piece', canChop: true },
        { name: 'грецкий орех', measure: 'piece', canChop: true }, { name: 'кедровый орех', measure: 'spoonT', canMix: true },
        { name: 'кешью', measure: 'piece', canChop: true }, { name: 'фисташки', measure: 'piece', canChop: true },
        { name: 'арахис', measure: 'piece', canChop: true }, { name: 'кунжут', measure: 'spoonC', canMix: true },
        { name: 'семена льна', measure: 'spoonC', canMix: true }, { name: 'семена чиа', measure: 'spoonC', canMix: true },
    ],
    spices: [
...
export const ACTIONS = [
    // Без параметров — чистый текст
    { text: "хорошо перемешать", hasParam: false, paramBase: 1 },
    { text: "тщательно взбить венчиком", hasParam: false, paramBase: 1 },
    { text: "аккуратно соединить лопаткой", hasParam: false, paramBase: 1 },
    { text: "перемешать до однородной массы", hasParam: false, paramBase: 1 },
    { text: "взбить миксером на средней скорости", hasParam: false, paramBase: 1 },
    { text: "растереть вилкой в пюре", hasParam: false, paramBase: 1 },
    { text: "замесить мягкое тесто", hasParam: false, paramBase: 1 },
    { text: "дать постоять 5 минут", hasParam: false, paramBase: 1 },
    { text: "накрыть и убрать в холодильник", hasParam: false, paramBase: 1 },
    { text: "процедить через сито", hasParam: false, paramBase: 1 },
    { text: "нарезать кубиком", hasParam: false, paramBase: 1 },
    { text: "нашинковать тонкой соломкой", hasParam: false, paramBase: 1 },
    { text: "измельчить в блендере", hasParam: false, paramBase: 1 },
    { text: "обжарить до золотистости", hasParam: false, paramBase: 1 },
    { text: "потушить под крышкой", hasParam: false, paramBase: 1 },
    { text: "довести до кипения", hasParam: false, paramBase: 1 },
    { text: "убавить огонь и томить", hasParam: false, paramBase: 1 },
    { text: "снять с огня и остудить", hasParam: false, paramBase: 1 },
    { text: "украсить по желанию", hasParam: false, paramBase: 1 },
    { text: "охладить до комнатной температуры", hasParam: false, paramBase: 1 },

    // С параметром: время (1-20 минут, база 20)
    { text: "выпекать {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "запекать {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "отправить в духовку на {0} мин.", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "томить на медленном огне {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "варить после закипания {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "жарить по {0} минут с каждой стороны", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "тушить под крышкой {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "настаивать {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "охладить в морозилке {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },
    { text: "мариновать {0} минут", hasParam: true, paramBase: 20, paramType: 'time' },

    // С параметром: температура (140-220°C с шагом 10, база 9)
    { text: "при {0}°C", hasParam: true, paramBase: 9, paramType: 'temp' },
    { text: "в разогретой до {0}°C духовке", hasParam: true, paramBase: 9, paramType: 'temp' },
    { text: "на среднем огне ({0}°C)", hasParam: true, paramBase: 9, paramType: 'temp' },

    // С параметром: порядок/этап (база 5)
    { text: "сначала {0}", hasParam: true, paramBase: 5, paramType: 'order' },
    { text: "затем {0}", hasParam: true, paramBase: 5, paramType: 'order' },
    { text: "после этого {0}", hasParam: true, paramBase: 5, paramType: 'order' },
    { text: "в конце {0}", hasParam: true, paramBase: 5, paramType: 'order' },
    { text: "перед подачей {0}", hasParam: true, paramBase: 5, paramType: 'order' },

    // Пустышки-описания для правдоподобия (не кодируются, добавляются случайно)
    { text: "по вкусу", hasParam: false, paramBase: 1, filler: true },
    { text: "при необходимости", hasParam: false, paramBase: 1, filler: true },
    { text: "до готовности", hasParam: false, paramBase: 1, filler: true },
    { text: "до лёгкой корочки", hasParam: false, paramBase: 1, filler: true },
    { text: "до мягкости", hasParam: false, paramBase: 1, filler: true },
    { text: "до золотистого цвета", hasParam: false, paramBase: 1, filler: true },
];